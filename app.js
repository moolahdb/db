...
document.write(
  '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/moolahdb/db@1.0.0/css/mdui_v2.min.css">'
);
document.write(
  '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/moolahdb/db@1.0.0/css/nexmoe_v2.min.css">'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/moolahdb/db@1.0.0/js/mdui.min.js"></script>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/moolahdb/db@1.0.0/js/flv.min.js"></script>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/moolahdb/db@1.0.0/js/DPlayer.min.js"></script>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/moolahdb/db@1.0.0/js/markdown-it.min.js"></script>'
);
document.write(
...
<header class="nexmoe-nav">
	<div class="navSize">
        ...
        UI.disable_navicon == true ? "none" : "block"
				...
				<ul class="menu_ul">
					<li class="menu_li"><a href="https://i.ibb.co/prtmKSD/fereshteh-azadi-Fkc2-Kr-T-5c-A-unsplash.jpg" alt="fereshteh-azadi-Fkc2-Kr-T-5c-A-unsplash"></a>" target="_blank">Love</a></li>
					<li class="menu_li"><a href="https://github.com/moolahdb/db" target="_blank">Github</a></li>
				</ul>
...
<script src="//cdn.jsdelivr.net/gh/moolahdb/db/js/ace.js"></script>
<script src="//cdn.jsdelivr.net/gh/moolahdb/db/js/ext-language_tools.js"></script>
	`;
  $("#content").html(content);
